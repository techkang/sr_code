...
class BasicBlockSig(nn.Sequential):
    def __init__(self, in_channels, out_channels, ksize=3, stride=1, pad=1, dilation=1):
        super().__init__()
...
class GBasicBlockSig(nn.Sequential):
...
class GResidualBlock(nn.Sequential):
    def __init__(self,
                 in_channels, out_channels):
        body = [
...
class EResidualBlock(nn.Sequential):
    def __init__(self,
                 in_channels, out_channels,
                 group=1):
        super().__init__()
...
class ConvertBlock(nn.Sequential):
